...
export function HomePage() {
  return (
    <SiteChrome path={pages.home.path}>
      ...
      <section className="band band-warm">
        <div className="shell">
          <h2 className="display-md">Inside the studio</h2>
          <div className="grid-auto mt-10">
            {home.tiles.map((tile) => (
              <Photo
                key={tile.src}
                ...
                alt={tile.alt}
                widths={[640, 1100]}
                sizes="(min-width: 900px) 20rem, 45vw"
                width={1100}
                height={1100}
                className="media"
              />
      ...
      <section className="band band-dark">
        <div className="shell grid-2">
          <div>
            ...
            <p className="mt-4 text-on-dark-soft">{site.app.androidNote}</p>
          ...
          <div className="card-dark">
            ...
            <p className="mt-3 text-on-dark-soft">
              One schedule for Northwest and Southwest.
            </p>
